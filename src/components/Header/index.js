...
import logo from '../../images/yzy_logo.png';
import './header.css';
...
function Header() {
    ...
    return (
        <Navbar collapseOnSelect expand="lg">
            <Navbar.Brand href="/"><img src={logo} className="logo" alt='YZY Logo' /></Navbar.Brand>
            <Navbar.Toggle aria-controls="responsive-navbar-nav" />
            <Navbar.Collapse id="responsive-navbar-nav">
                <Nav className="mr-auto">
                    <NavLink className="menu-item" to="/vault" activeStyle={{'color': "#FFBB00"}}>VAULT</NavLink>
                    <NavLink className="menu-item" to="/lottery" activeStyle={{'color': "#FFBB00"}} rel="noreferrer">LOTTERY</NavLink>
                    <Nav.Link className="menu-item" href="https://snapshot.page/#/yzydao.eth" activeStyle={{'color': "#FFBB00"}} target='_blank'>VOTE</Nav.Link>
                    <Nav.Link className="menu-item" href="https://yzydao.medium.com/introducing-yzy-dao-yzy-6c973279dad5" activeStyle={{'color': "#FFBB00"}} target='_blank' rel="noreferrer">ABOUT</Nav.Link>
                </Nav>
                <Nav>
                    <Nav.Link href="#">
                        {
                            address === null ?
                                (<Button variant="outline-warning" onClick={() => onConnectClick()}>Wallet Connect</Button>) :
